...
INSERT INTO config.Pipelines_Config
VALUES ('BO001', '[staging].[BO001_Results]', 'BO001_Results', 'ASQL', 'SFTP', ' ', 'full', 'date,home_team,away_team,home_score,away_score', 'sftp', 'csv',0);
INSERT INTO config.Pipelines_Config
VALUES ('BO001', '[staging].[BO001_Shootouts]', 'BO001_Shootouts', 'ASQL', 'SFTP', ' ', 'full', '*', 'sftp', 'csv',0);
INSERT INTO config.Pipelines_Config
VALUES ('BO001', '[staging].[BO001_History]', 'BO001_History', 'ASQL', 'ASQL', ' expireddate ≤ (getdate()-90) ', 'delete', '*', '', '',0);


-- BO002.sql  :Business Outcome 2 - Cricket Config
INSERT INTO config.Pipelines_Config
VALUES ('BO002', 'staging.BO002_Deliveries', 'BO002_Deliveries', 'ASQL', 'ABLB', '', 'full', '*','cricket-in' ,'csv',0);
INSERT INTO config.Pipelines_Config
VALUES ('BO002', 'staging.BO002_Matches', 'BO002_Matches', 'ASQL', 'ABLB', '', 'full', 'season,team1,team2,date,match_number,venue,city,toss_winner,toss_decision,player_of_match,winner,winner_runs,winner_wickets','cricket-in','csv',0);
INSERT INTO config.Pipelines_Config
VALUES ('BO002', 'staging.BO002_Pointstable', 'BO002_Pointstable', 'ASQL', 'ABLB', '', 'full', '*','cricket-in','csv',0);


-- BO003.sql  :Business Outcome 3 - Movie Config
 
INSERT INTO config.Pipelines_Config
VALUES('BO003', 'BO003_Movies', 'staging.BO003_Movies', 'ABLB', 'ASQL', '', 'full', '*','movie-in', '',0);
