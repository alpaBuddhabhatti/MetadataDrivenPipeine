...
INSERT INTO config.Pipelines_Config
VALUES ('BO002', 'config.BO002_Matches', 'BO002_Matches', 'ASQL', 'ABLB', '', 'full', 'c1,c2,c3,c4','cricket-in','csv',0);
INSERT INTO config.Pipelines_Config
...
INSERT INTO config.Pipelines_Config
VALUES('OB003', 'BO003_Movies', 'config.BO003_Movies', 'ABLB', 'ASQL', '', 'full', '*','', '',0);

--Delta Load for table2
DECLARE @last_Inserted_Spec_Code_Id INT;
INSERT INTO config.Pipelines_Config
VALUES('OB003', 'BO003_Ratings','stage.BO003_Ratings', 'ABLB', 'ASQL','table_id', 'delta', '*', '','',0);
...
VALUES('OB003', 'meetalpa@gmail.com', 'meetalpa@gmail.com', '', 'BO003 has successfully run', 0, '');
